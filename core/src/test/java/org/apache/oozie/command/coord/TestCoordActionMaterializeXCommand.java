...
public class TestCoordActionMaterializeXCommand extends CoordXTestCase {
    ...
    private void addRecordToJobTable(String jobId, Date startTime, Date endTime) throws CommandException {
    ...
    private void addRecordToJobTable(String jobId, Date startTime, Date endTime, Date pauseTime) throws CommandException {
        CoordinatorJobBean coordJob = new CoordinatorJobBean();
        coordJob.setId(jobId);
        coordJob.setAppName("testApp");
        coordJob.setStartTime(startTime);
