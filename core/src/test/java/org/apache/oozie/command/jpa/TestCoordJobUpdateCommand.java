...
public class TestCoordJobUpdateCommand extends XDataTestCase {
    Services services;
    ...
    private void _testUpdateJob(String jobId) throws Exception {
        ...
        CoordJobGetCommand jobGetCmd = new CoordJobGetCommand(jobId);
        CoordinatorJobBean job1 = jpaService.execute(jobGetCmd);
        job1.setStatus(CoordinatorJob.Status.SUCCEEDED);
        CoordJobUpdateCommand coordJobUpdateCommand = new CoordJobUpdateCommand(job1);
