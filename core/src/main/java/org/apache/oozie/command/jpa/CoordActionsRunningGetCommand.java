 ...
 */
public class CoordActionsRunningGetCommand implements JPACommand<List<CoordinatorActionBean>> {

    private long checkAgeSecs;

    public CoordActionsRunningGetCommand(long checkAgeSecs) {
        this.checkAgeSecs = checkAgeSecs;
    }

    @Override
    public String getName() {
        return "CoordActionsRunningGetCommand";
    }
