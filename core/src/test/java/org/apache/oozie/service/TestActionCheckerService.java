...
public class TestActionCheckerService extends XDataTestCase {
    ...
    public void testActionCheckerService() throws Exception {
        ...
        List<WorkflowActionBean> actions = jpaService.execute(actionsGetCmd);
        ...
        List<WorkflowActionBean> actions2 = jpaService.execute(actionsGetCmd);
    ...
    public void testActionCheckerServiceCoord() throws Exception {
        ...
        JPAService jpaService = Services.get().get(JPAService.class);
        CoordinatorActionBean recoveredAction = jpaService.execute(new CoordActionGetCommand(action.getId()));
