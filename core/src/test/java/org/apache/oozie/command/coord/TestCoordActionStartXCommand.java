...
public class TestCoordActionStartXCommand extends CoordXTestCase {
    public void testActionStartCommand() throws CommandException,
    ...
    private void addRecordToActionTable(String actionId, int actionNum) throws CommandException, IOException {
