...
public class TestCoordJobsToBeMaterializedCommand extends XFsTestCase {
    Services services;
    ...
    private void _testCoordJobsToBeMaterialized() {
        ...
        try {
            ...
            CoordJobsToBeMaterializedCommand cmatcmd = new CoordJobsToBeMaterializedCommand(d2, 50);
            ...
            CoordJobsToBeMaterializedCommand cmatcmdnew = new CoordJobsToBeMaterializedCommand(d2, 50);
