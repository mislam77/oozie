...
public class BundleKillTransitionXCommand extends KillTransitionXCommand {
    ...
    public BundleKillTransitionXCommand(String jobId) {
        super("bundle_kill", "bundle_kill", 1);
        this.jobId = ParamChecker.notEmpty(jobId, "jobId");
    }

    public BundleKillTransitionXCommand(String jobId, boolean dryrun) {
