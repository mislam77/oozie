 ...
 */
public class BundleJobsGetRunningCommand implements JPACommand<List<BundleJobBean>> {
    private int limit;

    public BundleJobsGetRunningCommand(int limit) {
        this.limit = limit;
    }

    @Override
    public String getName() {
        return "BundleJobsGetRunningCommand";
    }
