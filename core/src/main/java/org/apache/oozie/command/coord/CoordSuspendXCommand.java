...
public class CoordSuspendXCommand extends CoordinatorXCommand<Void> {
    ...
    protected Void execute() throws CommandException {
        try {
            ...
            List<CoordinatorActionBean> actionList = jpaService.execute(new CoordActionsGetForJobCommand(jobId));
            ...
            jpaService.execute(new CoordJobUpdateCommand(coordJobBean));
            return null;
        }
        catch (XException ex) {
