...
public class CoordActionCheckXCommand extends CoordinatorXCommand<Void> {
    ...
    protected Void execute() throws CommandException {
        try {
            incrJobCounter(1);
            WorkflowJobBean wf = jpaService.execute(new WorkflowJobGetCommand(coordAction.getExternalId()));
    ...
    protected void verifyPrecondition() throws CommandException, PreconditionException {
        ...
        if (cactionLmt.after(actionCheckTs)) {
            throw new PreconditionException(ErrorCode.E1100, "The coord action :" + actionId + " has been udated. Ignore CoordActionCheckCommand!");
        }
