...
public class StoreStatusFilter {
    ...
    public static final String bundleSeletStr = "Select w.id, w.appName, w.status, w.user, w.group, w.startTimestamp, w.endTimestamp, w.appPath, w.createdTimestamp, w.timeUnitStr, w.timeOut from BundleJobBean w";
