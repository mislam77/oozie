 ...
 */
public class BundleJobUpdateStatusCommand implements JPACommand<String> {

    private BundleJobBean bundleJob = null;

    public BundleJobUpdateStatusCommand(BundleJobBean bundleJob) {
    ...
    public String getName() {
        return "BundleJobUpdateStatusCommand";
    }
