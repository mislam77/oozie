...
public class TestDefinitionXCommand extends XDataTestCase {
    Services services;
    ...
    private void _testGetDefinition(String jobId) throws Exception {
        ...
        assertNotNull(ret);
        assertEquals(ret.getWorkflowInstance().getApp().getDefinition(), "<workflow-app/>");
    }
