...
/**
 * A list of unpaused Bundle Jobs;
 */
public class BundleJobsGetUnpausedCommand implements JPACommand<List<BundleJobBean>> {
    private int limit;

    public BundleJobsGetUnpausedCommand(int limit) {
        this.limit = limit;
    }

    @Override
    public String getName() {
        return "BundleJobsGetUnpausedCommand";
    }
