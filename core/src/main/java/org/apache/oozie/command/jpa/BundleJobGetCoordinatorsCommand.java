 ...
 */
public class BundleJobGetCoordinatorsCommand implements JPACommand<List<CoordinatorJobBean>> {
    private String bundleId = null;

    public BundleJobGetCoordinatorsCommand(String bundleId) {
    ...
    public String getName() {
        return "BundleJobGetCoordinatorsCommand";
    }
