 ...
 */
public class BundleJobsGetByStatusCommand implements JPACommand<List<BundleJobBean>> {

    private long checkAgeSecs;
    private String status;
    private int limit;

    public BundleJobsGetByStatusCommand(long checkAgeSecs, String status, int limit) {
    ...
    public String getName() {
        return "BundleJobsGetByStatusCommand";
    }
